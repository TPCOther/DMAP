        ...
        for name_and_score in sorted_list_of_names:
            ...
            for index, temp_prob in enumerate(logits):
                ...
                if temp_label != orig_label:
                    ...
                    return code, prog_length, sucpre_code, adv_code, true_label, orig_label, temp_label, is_success, variable_names, names_to_importance_score, nb_changed_var, nb_changed_pos, replaced_words, mix_substitutes
                else:
