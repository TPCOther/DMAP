...
from transformers import (AdamW, get_linear_schedule_with_warmup,
                          ...
                          T5Config, T5ForConditionalGeneration, T5Tokenizer,PLBartConfig, PLBartForConditionalGeneration, PLBartTokenizer)
...
def main():
    ...
    config.num_labels=2
    tokenizer = PLBartTokenizer.from_pretrained(args.tokenizer_name)
